      ...
      body: JSON.stringify({
        ...
        html: emailTemplate({
          bodyHtml: `
            ...
            <p style="margin:0 0 32px;">C'est parti. Ton accès à <strong>${programLabel}</strong> est confirmé. Clique sur le bouton et programme ta première séance dans ton profil dès aujourd'hui.</p>
