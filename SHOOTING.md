...
| ☐ | SDT Jambes Tendues | ✓ | | jambes quasi tendues |
| ☐ | Sumo Squat Barre | ✓ | | écartement large |

### BAS DU CORPS · Haltères
...
| ☐ | Exercice | V1 | V2 | Placement |
|---|----------|:--:|:--:|-----------|
| ☐ | Leg Press | ✓ | | pieds sur plateforme |
| ☐ | Leg Curl | ✓ | | allongée face basse |
| ☐ | Leg Extension | ✓ | | assise, jambes tendues |
...
| ☐ | Développé Arnold | ✓ | ✓ | rotation prise en montant |
...
| ☐ | Exercice | V1 | V2 | Placement |
|---|----------|:--:|:--:|-----------|
| ☐ | Planche Coude | ✓ | ✓ | appui coudes, corps droit |
| ☐ | Planche Latérale | ✓ | ✓ | appui côté, corps aligné |
| ☐ | Planche Rotation Hanche | ✓ | ✓ | planche, hanche vers sol |
| ☐ | Dead Bug | ✓ | ✓ | allongée, bras jambe opposés |
| ☐ | Bird Dog | ✓ | ✓ | quadrupédie, bras jambe tendus |
...
## 📍 EN STUDIO · V2 uniquement

### BAS DU CORPS · Sol + Haltères

| ☐ | Exercice | V1 | V2 | Placement |
|---|----------|:--:|:--:|-----------|
| ☐ | Hip Thrust Haltère Sol | | ✓ | sol, haltère sur hanches |
| ☐ | Glute Bridge | | ✓ | sol, hanches vers plafond |
...
| ☐ | Exercice | V1 | V2 | Placement |
|---|----------|:--:|:--:|-----------|
| ☐ | Tirage Vertical Élastique | | ✓ | élastique fixé au-dessus |
| ☐ | Tirage Horizontal Élastique | | ✓ | élastique fixé devant |
| ☐ | Face Pull Élastique | | ✓ | élastique vers le visage |
| ☐ | Oiseau Élastique | | ✓ | élastique, bras ouverts |
| ☐ | Rowing Haltère sur Chaise | | ✓ | genou sur chaise |

### HAUT DU CORPS · Push Sol

| ☐ | Exercice | V1 | V2 | Placement |
|---|----------|:--:|:--:|-----------|
| ☐ | Développé Couché Sol | | ✓ | allongée sol, haltères |
| ☐ | Développé Incliné sur Chaise | | ✓ | dos incliné sur chaise |
