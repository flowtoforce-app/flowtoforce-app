...
// Deux capsules verticales côte à côte — style 3D glossy bleu
const dumbbell = `
  <span style="display:inline-block;width:22px;height:58px;background:linear-gradient(to right,#c8dff2 0%,#7aaac8 40%,#4a7faa 70%,#3a6898);border-radius:50px;vertical-align:middle;margin:0 6px;box-shadow:inset -4px 0 10px rgba(0,0,0,0.18),inset 3px 0 6px rgba(255,255,255,0.35),0 6px 16px rgba(30,80,140,0.4);"></span>
  <span style="display:inline-block;width:22px;height:58px;background:linear-gradient(to right,#c8dff2 0%,#7aaac8 40%,#4a7faa 70%,#3a6898);border-radius:50px;vertical-align:middle;margin:0 6px;box-shadow:inset -4px 0 10px rgba(0,0,0,0.18),inset 3px 0 6px rgba(255,255,255,0.35),0 6px 16px rgba(30,80,140,0.4);"></span>`
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:radial-gradient(ellipse at 20% 10%,rgba(255,255,255,0.14) 0%,transparent 45%),radial-gradient(ellipse at 80% 85%,rgba(255,255,255,0.08) 0%,transparent 40%),linear-gradient(155deg,#1E5A88 0%,#2E70A0 22%,#3A80B0 44%,#507090 68%,#6B5870 100%);min-height:100vh;">
  <tr>
    <td align="center" style="padding:40px 20px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">

        <!-- LOGO stacked : flow / ligne / force -->
        <tr>
          <td style="padding:44px 40px 0;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="text-align:left;padding-bottom:6px;">
                  <span style="font-family:Georgia,'Times New Roman',serif;font-size:52px;color:rgba(255,255,255,0.95);font-weight:300;letter-spacing:3px;line-height:1;">flow</span>
                </td>
              </tr>
              <tr>
                <td style="padding:0 0 6px;">
                  <div style="width:70px;height:1px;background:rgba(255,255,255,0.55);margin:0 auto 0 4px;"></div>
                </td>
              </tr>
              <tr>
                <td style="text-align:right;padding-bottom:0;">
                  <span style="font-family:Georgia,'Times New Roman',serif;font-size:52px;color:rgba(255,255,255,0.95);font-weight:300;letter-spacing:3px;line-height:1;">force</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td align="center" style="padding:12px 24px 32px;">
            <table role="presentation" cellpadding="0" cellspacing="0" style="display:inline-table;border-collapse:separate;border-spacing:12px;">
              <tr>
                <td align="center" valign="middle" style="width:50px;height:50px;background:linear-gradient(135deg,#4a9fe8,#2a6bc9);border-radius:14px;box-shadow:0 4px 12px rgba(30,80,160,0.4);">
                  <a href="https://www.instagram.com/flowtoforce" style="display:block;width:50px;height:50px;text-align:center;text-decoration:none;line-height:50px;">${iconInstagram}</a>
                </td>
                <td align="center" valign="middle" style="width:50px;height:50px;background:linear-gradient(135deg,#4a9fe8,#2a6bc9);border-radius:14px;box-shadow:0 4px 12px rgba(30,80,160,0.4);">
                  <a href="https://www.tiktok.com/@flowtoforce" style="display:block;width:50px;height:50px;text-align:center;text-decoration:none;line-height:50px;">${iconTiktok}</a>
                </td>
              </tr>
            </table>
          </td>
