  ...
  <tr>
    <td align="center" style="padding:40px 20px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <!-- BANNIÈRE LOGO -->
        <tr>
          <td align="center" style="background:#060d1f;border-radius:14px 14px 0 0;padding:22px 0 20px;border-bottom:1px solid rgba(255,255,255,0.08);">
            <span style="font-family:Georgia,'Times New Roman',serif;font-size:17px;color:rgba(255,255,255,0.92);font-weight:300;letter-spacing:5px;font-style:italic;">flow</span>
            <span style="font-family:Georgia,'Times New Roman',serif;font-size:17px;color:rgba(255,255,255,0.92);font-weight:300;letter-spacing:5px;padding:0 14px;">—</span>
            <span style="font-family:Georgia,'Times New Roman',serif;font-size:17px;color:rgba(255,255,255,0.92);font-weight:300;letter-spacing:5px;">force</span>
          </td>
        </tr>
