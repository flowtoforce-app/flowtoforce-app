...
export function emailTemplate({ bodyHtml, ctaLabel, ctaUrl, imageUrl }) {
  ...
  const photo = imageUrl ? `
        <tr>
          <td align="center" style="padding:32px 0 24px;">
            <img src="${imageUrl}" width="260" alt="" style="display:block;width:260px;height:auto;border-radius:16px;object-fit:cover;" />
          </td>
        </tr>` : ''
  ...
  <tr>
    <td align="center" style="padding:40px 20px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <!-- LOGO : flow / ligne / force -->
        <tr>
          <td align="center" style="padding:48px 0 0;">
            <table role="presentation" cellpadding="0" cellspacing="0">
              <tr>
                <td style="text-align:left;padding-bottom:8px;white-space:nowrap;">
                  <span style="font-family:Georgia,'Times New Roman',serif;font-size:54px;color:rgba(255,255,255,0.95);font-weight:300;letter-spacing:4px;line-height:1;font-style:italic;">flow</span>
                </td>
              </tr>
              <tr>
                <td style="padding-bottom:8px;">
                  <div style="width:60px;height:1px;background:rgba(255,255,255,0.5);"></div>
                </td>
              </tr>
              <tr>
